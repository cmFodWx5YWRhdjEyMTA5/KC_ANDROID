...
public class BranchExpense {
    ...
    public BranchExpense(int user_id, String bch_date, String branch_name, String expense_type, String lr_number, String trip_expense_type, String bch_amount, String bch_desc) {
